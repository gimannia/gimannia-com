...
export default function Home() {
  ...
  const paragraphs = [
    "I knew coming to the US and specifically to New York would be fun (and slightly scary), but when you walked into my life and became my lovely partner, everything started to feel better.",
